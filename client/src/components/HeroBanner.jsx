...
const HeroBanner = ({ movies, onPlay, onShowDetails }) => {
  ...
  return (
    <div className="relative w-full h-[80vh] md:h-[90vh] overflow-hidden" data-testid="hero-banner">
      ...
      <div className="absolute inset-0">
        <img
          src={currentMovie.backdrop_url || currentMovie.backdropUrl || currentMovie.poster_url || currentMovie.posterUrl}
      ...
      <div className="relative h-full max-w-7xl mx-auto px-4 md:px-6 flex flex-col justify-center md:justify-end pb-24 md:pb-24">
        <div className="max-w-2xl">
          ...
          <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6 text-xs md:text-sm text-foreground/80">
            ...
            <span>•</span>
            <span>{currentMovie.duration || currentMovie.duration_minutes || 0}m</span>
            <span>•</span>
            <div className="flex items-center gap-1">
              <span className="text-accent">★</span>
              <span className="font-semibold">{currentMovie.rating ? parseFloat(currentMovie.rating).toFixed(1) : 'N/A'}</span>
            </div>
          </div>
